...
public class Player4 implements PlayerStrategy{
	int playerId;
	...
	public void receiveCard(Card drawnCard) {
		System.out.println("Player - 4 recieved :"+drawnCard.getRank()+" "+drawnCard.getSuit());
	...
	public Card playCard() {
		...
		if(changedSuit==null) 
        {
			for(int i=0;i<myCards.size();i++) 
			{
				...
				{
					System.out.println("Player - 4 played : "+myCards.get(i).getRank()+" "+myCards.get(i).getSuit());
